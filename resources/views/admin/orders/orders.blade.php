                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button name="status" class="dropdown-item"
                                                        style="color: {{ $order->status == 0 ? 'blue' : '' }}"
                                                        value="0">Placed</button>
                                                    <button name="status" class="dropdown-item"
                                                        style="color: {{ $order->status == 1 ? 'blue' : '' }}"
                                                        value="1">Processing
                                                    </button>
                                                    <button name="status" class="dropdown-item"
                                                        style="color: {{ $order->status == 2 ? 'blue' : '' }}"
                                                        value="2">Shipped</button>
                                                    <button name="status" class="dropdown-item"
                                                        style="color: {{ $order->status == 3 ? 'blue' : '' }}" value="3">Out
                                                        for delevery
                                                    </button>
                                                    <button name="status" class="dropdown-item"
                                                        style="color: {{ $order->status == 4 ? 'blue' : '' }}"
                                                        value="4">Delevered
                                                    </button>
                                                    <button name="status" class="dropdown-item"
                                                        style="color: {{ $order->status == 5 ? 'blue' : '' }}"
