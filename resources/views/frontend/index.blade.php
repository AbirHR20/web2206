                    ...
                    <div class="featured-item">
                        <div class="images">
                            <img src="{{ asset('uploads/category') }}/{{ $category->category_img }}" alt=""
                                style="width: 70px !important; margin:auto;">
                        </div>
                        <div class="text">
                            <h2>
                            ...
                            <div class="product-item">
                                <div class="image">
                                    ...
                                    @if ($product->product_discount)
                                        <div class="tag sale">{{ $product->product_discount }}%</div>
                                    @else
        ...
        <div class="container">
            ...
            <div class="trendin-slider owl-carousel">
                @foreach ($products as $product)
                    <div class="product-item">
                        <div class="image">
                            <img height="250" src="{{ asset('uploads/product/preview') }}/{{ $product->preview }}"
                                alt="">
                            @if ($product->product_discount)
                                <div class="tag sale">{{ $product->product_discount }}%</div>
                            @else
                        ...
                        <div class="text">
                            <h2>
                                @if (Str::length($product->product_name) > 20)
                                    <a title="{{ $product->product_name }}"
                                        href="product.html">{{ Str::substr($product->product_name, 0, 20) . '...' }}</a>
                                @else
                                    <a title="{{ $product->product_name }}"
