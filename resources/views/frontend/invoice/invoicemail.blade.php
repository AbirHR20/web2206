                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            Hello,
                                                            {{ App\Models\Billing::where('order_id', $order_id)->first()->fname . ' ' . App\Models\Billing::where('order_id', $order_id)->first()->lname }}.
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    {{ $billing->fname }}
                                                                    {{ $billing->lname }}<br>{{ $billing->address }}<br>
                                                                    {{ $billing->rel_to_city->name }}<br>
                                                                    4468,{{ $billing->rel_to_country->name }}<br> T:
                                                                    {{ $billing->phone }}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    ...
                                                    <table width="220" border="0" cellpadding="0"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                                                    {{ $shipping->ship_fname }}<br>
                                                                    {{ $shipping->ship_address }}<br>
                                                                    {{ $shipping->rel_to_city->name }}<br>
                                                                    {{ $shipping->ship_zip }},
                                                                    {{ $shipping->rel_to_country->name }}<br> T:
                                                                    {{ $shipping->ship_phone }}
                                                                </td>
                                                            </tr>
                                                        </tbody>
