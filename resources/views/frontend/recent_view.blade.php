                    ...
                    @foreach ($recent_viewed_product as $recent)
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-item">
                                <div class="image">
                                    <img height="200" src="{{ asset('uploads/product/preview') }}/{{ $recent->preview }}"
                                        alt="">
                                    <div class="tag new">New</div>
                                </div>
                                <div class="text">
                                    <h2><a
                                            href="{{ route('products.details', $recent->slug) }}">{{ $recent->product_name }}</a>
                                    </h2>
                                    ...
                                    <div class="price">
                                        <span class="present-price">&#2547;{{ $recent->after_product_discount }}</span>
                                        <del class="old-price">&#2547;{{ $recent->product_price }}</del>
                                    </div>
                                    <div class="shop-btn">
                                        <a class="theme-btn-s2" href="{{ route('products.details', $recent->slug) }}">Shop
                                            Now</a>
                                    </div>
                                </div>
                            </div>
